...
This module contains the STMicroelectronics configuration for Android used to generate images adapted to the STM32MP2 DK board.
It is part of the STMicroelectronics delivery for Android.

The STM32MP2 DK board integrates a STMicroelectronics STM32MP2 chip.
...
* `aosp_dk.mk`: specific product configuration (include different makefiles depending on product configuration)
...
**Sepolicy**
* `./sepolicy`: sepolicy for STM32MP25 Discovery boards
